      ...
      <div className="flex-1 flex flex-col md:ml-64 min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-2 md:p-6 pt-24 md:pt-6 mobile-main max-w-full">
          <div className="mb-4 md:mb-6 text-center">
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Investment Tools</h1>
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">Professional tools for investment analysis and planning</p>
          </div>
